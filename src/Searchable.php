...
trait Searchable
{
     ...
     * @return \Shopwwi\WebmanScout\Builder
     */
    public static function search($query = '', $callback = null)
    {
        return app(Builder::class, [
            ...
            'query' => $query,
            'callback' => $callback,
            'softDelete'=> static::usesSoftDelete() && config('plugin.shopwwi.scout.app.soft_delete', false),
        ]);
    }
    ...
    {
        return config('plugin.shopwwi.scout.app.prefix').$this->getTable();
    }
